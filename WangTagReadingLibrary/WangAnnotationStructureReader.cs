...
namespace WangTagReadingLibrary
{
    ...
    internal static class WangAnnotationStructureReader
    {
        ...
        public static string ReadCharString(IWangStream stream, int count)
        {
            ...
            // Sligth optimization compared to System.Text.Encoding.GetEncoding(932).GetString(buffer, 0, count).TrimEnd('\0');
            ...
            return Encoding.GetEncoding("Shift-JIS").GetString(buffer, 0, actualCount);
        }
        ...
        public static WangHyperlink ReadHyperlink(IWangStream stream, int dataSize)
        {
             ...
             * int          nFlags              One or more of the following flags ORfed together:
