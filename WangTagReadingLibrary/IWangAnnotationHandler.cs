...
namespace WangTagReadingLibrary
{
    ...
    internal interface IWangAnnotationHandler
    {
        ...
        /// <param name="colorComponents">The color of the text.</param>
        /// <param name="fontSize">The font size.</param>
        void AddTextAnnot(int leftPixels, int topPixels, int widthPixels, int heightPixels, string text, bool italic, bool underline, string fontName, int fontSize, int rotation, byte[] colorComponents);
